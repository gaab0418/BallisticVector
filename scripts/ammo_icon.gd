...
func _draw():
	...
	draw_rect(Rect2(bx + bullet_w * 0.7, by + bullet_h * 0.4, bullet_w * 0.3, bullet_h * 0.5), shadow)
	
	# Base da cápsula
	draw_rect(Rect2(bx - 2, by + bullet_h * 0.9, bullet_w + 4, bullet_h * 0.1), Color(0.6, 0.4, 0.15))
	...
	draw_line(Vector2(bx, by + bullet_h * 0.6), Vector2(bx + bullet_w, by + bullet_h * 0.6), Color(0.4, 0.2, 0.1), 2.0)
	draw_line(Vector2(bx, by + bullet_h * 0.8), Vector2(bx + bullet_w, by + bullet_h * 0.8), Color(0.4, 0.2, 0.1), 2.0)
